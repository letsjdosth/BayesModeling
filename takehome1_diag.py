...
if __name__=="__main__":
    ...
    indepmodel_diag_inst.print_summaries(round=6)
    ...
    hmodel_diag_inst1.show_hist((2,3), high_rank_list+[37])
    hmodel_diag_inst1.show_traceplot((2,3), low_rank_list+[37])
    hmodel_diag_inst1.show_acf(30, (2,3), low_rank_list+[37])
    hmodel_diag_inst1.show_hist((2,3), low_rank_list+[37])
    
    hmodel_diag_inst1.print_summaries(6)
    ...
    hmodel_diag_inst_for_p_1.print_summaries(6)
